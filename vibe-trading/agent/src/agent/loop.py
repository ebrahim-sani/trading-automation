            ...
            while iteration < self.max_iterations:
                ...
                for tc in response.tool_calls:
                    ...
                    if tc.name == "compact":
                        ...
                        messages.append(context.format_tool_result(tc.id, "compact", '{"status":"ok","message":"Compressing..."}', thought_signature=sig))
                    ...
                    if tc.name in self._called_ok and not is_repeatable:
                        ...
                        sig = getattr(tc, "thought_signature", None)
                        messages.append(context.format_tool_result(tc.id, tc.name, skip_msg, thought_signature=sig))
                    ...
                    sig = getattr(tc, "thought_signature", None)
                    messages.append(context.format_tool_result(tc.id, tc.name, truncated, thought_signature=sig))
