...
class ContextBuilder:
    ...
    @staticmethod
    def format_tool_result(tool_call_id: str, tool_name: str, result: str, thought_signature: Optional[str] = None) -> Dict[str, Any]:
    ...
    def format_assistant_tool_calls(tool_calls: list, content: Optional[str] = None) -> Dict[str, Any]:
        ...
        for tc in tool_calls:
            ...
            # Carry over the signature!
            if hasattr(tc, "thought_signature") and tc.thought_signature:
                fdef["thought_signature"] = tc.thought_signature
            
            formatted_calls.append({
                "id": tc.id,
                "type": "function",
                "function": fdef,
                # Also store at the call level for easier access
